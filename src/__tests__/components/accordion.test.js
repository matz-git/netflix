...
describe('<Accordion />', () => {
  ...
  it('opens and closes the <Accordion /> component', () => {
    ...
    const whatIsNetflixBodyText2 = 
      "<span>Netflix is a streaming service that offers a wide variety of award-winning TV programmes, films, anime, documentaries and more – on thousands of internet-connected devices. You can watch as much as you want, whenever you want, without a single advert – all for one low monthly price. There's always something new to discover, and new TV programmes and films are added every week!</span>";
    ...
    expect(queryByText(whatIsNetflixBodyText2)).toBeFalsy();
    fireEvent.click(queryByText('What is Netflix?'));
    expect(getByText(whatIsNetflixBodyText)).toBeTruthy();
